...
// const ORIGIN_LOCATION = LOCATION_PATH.ACCOUNT.SECURITY.CHNG_PSWD;
        ...
        <div className='flex flex-col gap-5 px-7 py-4 my-4 bg-background-alt rounded-lg shadow-sm'>
            <div className="flex flex-col gap-2">
                <div className="flex items-center gap-2">
                    ...
                    <h2 className="py-2 text-xl text-text-base">Change Password</h2>
                </div>
                <p className="text-sm text-text-base/70">Change your account password.</p>
            </div>
